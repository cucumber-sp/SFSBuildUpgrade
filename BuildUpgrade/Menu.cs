...
namespace BuildUpgrade
{
    public class Menu : MonoBehaviour
    {
        ...
        void ModGUIPartWindow(int windowID)
        {
            ...
            {
                x_orientation_string = (float.Parse(x_orientation_string, CultureInfo.InvariantCulture) - 0.1f).ToString("0.0", CultureInfo.InvariantCulture);
            ...
            {
                y_orientation_string = (float.Parse(y_orientation_string, CultureInfo.InvariantCulture) - 0.1f).ToString("0.0", CultureInfo.InvariantCulture);
                BuildMethods.ApplyOrientation();
                BuildMethods.RefreshPartValues();
            }
            ...
            {
                z_orientation_string = (float.Parse(z_orientation_string, CultureInfo.InvariantCulture) - 1f).ToString("0.0", CultureInfo.InvariantCulture);
                BuildMethods.ApplyOrientation();
                BuildMethods.RefreshPartValues();
            }
            ...
            {
                x_position_string = (float.Parse(x_position_string, CultureInfo.InvariantCulture) - 0.1f).ToString("0.0", CultureInfo.InvariantCulture);
            ...
            {
                y_position_string = (float.Parse(y_position_string, CultureInfo.InvariantCulture) - 0.1f).ToString("0.0", CultureInfo.InvariantCulture);
                BuildMethods.ApplyPosition();
                BuildMethods.RefreshPartValues();
            }
            ...
            {
                width_original_string = (float.Parse(width_original_string, CultureInfo.InvariantCulture) - 0.1f).ToString("0.0", CultureInfo.InvariantCulture);
            ...
            {
                width_b_string = (float.Parse(width_b_string, CultureInfo.InvariantCulture) - 0.1f).ToString("0.0", CultureInfo.InvariantCulture);
                BuildMethods.ApplySize();
                BuildMethods.RefreshPartValues();
            }
            ...
            {
                width_a_string = (float.Parse(width_a_string, CultureInfo.InvariantCulture) - 0.1f).ToString("0.0", CultureInfo.InvariantCulture);
                BuildMethods.ApplySize();
                BuildMethods.RefreshPartValues();
            }
            ...
            {
                height_string = (float.Parse(height_string, CultureInfo.InvariantCulture) - 0.1f).ToString("0.0", CultureInfo.InvariantCulture);
                BuildMethods.ApplySize();
                BuildMethods.RefreshPartValues();
            }
